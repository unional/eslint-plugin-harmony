...
exports.default = createRule_1.createRule({
    ...
    create(context, [options]) {
        ...
        const interfaceOptions = experimental_utils_1.ESLintUtils.deepMerge(baseOptions, overrides.interface);
        const typeLiteralOptions = experimental_utils_1.ESLintUtils.deepMerge(baseOptions, overrides.typeLiteral);
        /**
